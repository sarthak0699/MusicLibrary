...
public class MostPlayed extends javax.swing.JFrame {
    ...
    public ArrayList<Song> songList()
    {
        ...
        try{
            ...
            String query1="select song_name,play_count from song order by play_count desc limit 10";
            ...
            while(rs.next())
            { 
                song=new Song(rs.getString("song_name"),rs.getInt("play_count"));
                songsList.add(song);

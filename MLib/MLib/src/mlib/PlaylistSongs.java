 ...
 * @author sarthak
 */
public class PlaylistSongs extends javax.swing.JFrame {

    /**
     * Creates new form PlaylistSongs
     */
    int pid;
   
    ArrayList<Song> songsList=new ArrayList<>();
    public PlaylistSongs(String pname) {
        initComponents();
        ...
        Class.forName("com.mysql.cj.jdbc.Driver");
            ...
            String query1="select playlist_ID from playlistname where user_id="+WelcomePage.userid+" and playlist_name="+"'"+pname+"'";
    ...
    public ArrayList<Song> songList()
    {
        ...
        try{
            ...
            String query1="Select song_name,artist_name,album_name,Year,song_id from artist natural join song natural join album where song_id in(Select song_id from playlist where playlist_ID="+pid+")";
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery(query1);
            Song song;
    ...
    private void initComponents() {
        ...
        song_table.setAutoCreateRowSorter(true);
        ...
        song_table.setSelectionForeground(new java.awt.Color(255, 255, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlaylistSongs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
